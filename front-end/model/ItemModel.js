...
export function saveItem(item) {
    ...
    $.ajax({
        url : "http://localhost:8080//back_end_war_exploded/item",
        method : "POST",
...
export function getAllItems() {
    ...
    return new Promise((resolve, reject) => {
        $.ajax({
            url: `http://localhost:8080//back_end_war_exploded/item?id=all`,
            method: "GET",
...
export function deleteItem(index){
    $.ajax({
        url : `http://localhost:8080//back_end_war_exploded/item?id=${index}`,
        method : "DELETE",
        success : function (data){
            console.log(data);
        }
